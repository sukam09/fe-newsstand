...
export default function ContentNav($target, mode) {
  this.state = mode;
  ...
  this.render = () => {
    ...
    $nav.innerHTML = `<div class="news-navbar_newspaper">
    <span class="news-navbar_newspaper-list-all mouse-hover-pointer"
      >전체 언론사</span
    >
    <span class="news-navbar_newspaper-list-my mouse-hover-pointer"
      >내가 구독한 언론사</span
    >
    </div>
    <div class="news-navbar_content">
    <span class="news-navbar_content-news mouse-hover-pointer">
      <svg
        class="view-line"
        width="24"
        height="24"
    ...
    <span class="news-navbar_content-newspaper mouse-hover-pointer">
      <svg
        class="view-chess"
        width="24"
        height="24"
