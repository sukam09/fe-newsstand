...
export function makeCorpViewTag() {
  ...
  const li = `
    <li class="main__first-corp-left main-—corp-name card_sliding"></li>
...
export function makeRightCorpViewTag() {
  ...
  const li = ` 
    <li class="main__first-corp-right main-—corp-name card_sliding"></li>
...
export function makeRightTitleViewTag() {
  ...
  const li = `
    <li class="main__first-title-right main—-news-box card_sliding"></li>
